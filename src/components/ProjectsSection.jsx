...
const projects = [
  {
    ...
    description:
      'An end-to-end Credit Card Fraud Detection system built using Machine Learning, FastAPI, and an interactive HTML UI. This project takes real transaction data, analyzes it using a trained ML model, and returns real-time predictions with fraud probability.',
    image: '/projects/CreditFraud.png',
    tags: ['Python', 'JS', 'NumPy', 'Pandas'],
    demoUrl: '#',
    githubUrl: 'https://github.com/ASHuchihaFR/Credit-Card-Fraud-Detection-System',
    demoStatus: 'offline',
  },
  {
    id: 2,
    title: 'Real-Time DDoS Detection System',
    description:
    ...
    demoUrl: '#',
    githubUrl: 'https://github.com/ASHuchihaFR/DDOS-Detection-System',
    demoStatus: 'offline',
  },
  {
    id: 3,
    ...
    description:
      'Developed a secure e-voting application using a custom Python blockchain to ensure data integrity and immutability. The system allows users to register, log in, and cast a single, tamper-proof vote, while an administrator can monitor real-time results via a dashboard.',
    image: '/projects/BlockchainVote.png',
    tags: ['Java', 'Blockchain'],
    demoUrl:
      '#',
    githubUrl: 'https://github.com/ASHuchihaFR/Block-chain-Based-Voting-System',
    demoStatus: 'offline',
  },
  {
    id: 4,
    ...
    description:
      'Smart Task Analyzer is a full-stack productivity tool that helps users analyze, rank, and prioritize tasks based on multiple real-world productivity factors such as urgency, importance, estimated effort, and dependencies.',
    image: '/projects/SmartAnalyzer.png',
    tags: ['Python', 'Django REST Framework', 'JavaScript', 'React', 'Tailwind CSS '],
    demoUrl: '#',
    githubUrl: 'https://github.com/ASHuchihaFR/Smart-Task-Analyzer',
    demoStatus: 'offline',
  },
  {
    id: 5,
    ...
    description:
      'Developed a web application to help job seekers bypass Applicant Tracking Systems (ATS) by analyzing resumes against job descriptions to provide a match score and actionable feedback.',
    image: '/projects/ResumeAnalyzer.png',
    tags: ['Node.js', 'EJS', 'JavaScript', 'CSS'],
    demoUrl: '#',
    githubUrl: 'https://github.com/ASHuchihaFR/Resume-Analyzer',
    demoStatus: 'offline',
  },
];
